...
# Fargepalett - moderne mørkt tema
DARK_BG = "#181818"           # Mørkere bakgrunn (hovedbakgrunn)
DARKER_BG = "#252526"         # Sekundær bakgrunn (for paneler)
DARKER_PANEL = "#2D2D2D"      # Mørkere panel bakgrunn
CARD_BG = "#222222"           # Bakgrunn for kort-elementer
ACCENT_COLOR = "#2374E1"      # Blå aksentfarge
ACCENT_HOVER = "#3385F2"      # Lysere aksentfarge for hover
...
HEADER_BG = "#1D1D1D"         # Bakgrunnsfarge for topptekst
CARD_BORDER = "#363636"       # Kort-border
